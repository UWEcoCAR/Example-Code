...
// result of checkbox tick...magical heart!
window.onload = function() {
  initCheckbox("top-box", "top-titlebar", "heart.png", "Top Titlebar");
  initCheckbox("bottom-box", "bottom-titlebar", "heart.png", "Bottom Titlebar");
  initCheckbox("left-box", "left-titlebar", "heart.png", "Left Titlebar");
  initCheckbox("right-box", "right-titlebar", "heart.png", "Right Titlebar");

  document.getElementById("close-window-button").onclick = function() {   // close window functionality
    window.close();
  }
